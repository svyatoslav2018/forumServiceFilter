...
public interface AccountService {
	...
	Set<String> addRole(String login, String role, String token);// кому,что, кто хочет изменить

	Set<String> removeRole(String login, String role, String token);// кому,что, кто хочет изменить
